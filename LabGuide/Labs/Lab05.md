...
3. On the **Submit to Microsoft for analysis** flyout that opens, configure the following settings and select **Submit**:
   ...
   - **URL**: www.ucoz.com
   - **Why are you submitting this URL to Microsoft**: I've confirmed it's clean.

   ![Picture 1](../Media/allow5.png)

   >**Note**: The block URL will have higher priority if you block and allow the same URL.

5. Back on the **Submissions** tab, the entry is listed.

   ![Picture 1](../Media/allow6.png)
   
   >**Note**: The completion process may take up to 24 hours.
## Review
In this lab, you will complete the following tasks:
- Created Block List
- Created Allow List
